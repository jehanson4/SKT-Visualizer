...
class BlockFigure : Figure {
    ...
    private var _pov_default: BlockPOV = BlockPOV(1,0,0,1) // temp value
    private var _pov: BlockPOV = BlockPOV(1,0,0,1) // temp value
    ...
    private func fixPOV(_ pov: BlockPOV) -> BlockPOV {
        ...
        return BlockPOV(r2, phi2, thetaE2, zoom2)
    }
    ...
    func handlePan(_ sender: UIPanGestureRecognizer) {
        ...
        // NEW
        pov = BlockPOV(pov.r, phi2, thetaE2, pov.zoom)
    ...
    func handlePinch(_ sender: UIPinchGestureRecognizer) {
        ...
        // NEW
        pov = BlockPOV(pov.r, pov.phi, pov.thetaE, newZoom)

...
class SK2_Figure_20 : Figure20 {
    ...
    init(name: String, group: String, system: SK2_System19, geometry: SK2Geometry20, colorSource: DS_ColorSource20, relief: DS_ElevationSource20) {
        self.name = name
        self.group = group
        self.system = system

//
//  AdjustableParameterSequencer.swift
//  SKT Visualizer
//
...
class AdjustabmeParameterSequencer<T> : Sequencer {
    ...
    private var fParam: AdjustableParameter<T>
    ...
    init(_ parameter: AdjustableParameter) {
